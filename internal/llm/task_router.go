...
func (r *TaskRouter) Generate(ctx context.Context, task TaskType, messages message.Prompt) (*types.LLMResponse, error) {
...
func (r *TaskRouter) GenerateWithoutTools(ctx context.Context, task TaskType, messages message.Prompt) (*types.LLMResponse, error) {
	provider := r.GetProvider(task)
	if provider == nil {
		log.Printf("⚠️  TaskRouter: No provider for task '%s' and no fallback set", task)
		return nil, ErrNoProvider
...
func (r *TaskRouter) Chat(ctx context.Context, messages message.Prompt, maxIterations int) (*types.LLMResponse, message.Prompt, error) {
...
func (r *TaskRouter) ChatWithStreaming(ctx context.Context, messages message.Prompt, maxIterations int, streamCallback types.StreamCallback, toolCallback types.ToolEventCallback) (*types.LLMResponse, message.Prompt, error) {
	provider := r.GetProvider(TaskChat)
	if provider == nil {
		return nil, nil, ErrNoProvider
	}
...
func (r *TaskRouter) GenerateTitle(ctx context.Context, messages message.Prompt) (*types.LLMResponse, error) {
	return r.GenerateWithoutTools(ctx, TaskTitleGen, messages)
}

// GenerateSummary is a convenience method for summary generation
func (r *TaskRouter) GenerateSummary(ctx context.Context, messages message.Prompt) (*types.LLMResponse, error) {
...
func (r *TaskRouter) DescribeImage(ctx context.Context, messages message.Prompt) (*types.LLMResponse, error) {
