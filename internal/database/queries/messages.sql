...
SELECT * FROM message_plugins WHERE id = ?;
...
SELECT * FROM message_tts WHERE id = ?;
...
SELECT * FROM message_translates WHERE id = ?;
...
SELECT * FROM message_queries WHERE id = ?;
...
WHERE mqc.message_id IN (sqlc.slice('messageIds'));
