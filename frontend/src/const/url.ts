...
export const DOCKER_IMAGE = 'https://hub.docker.com/r/kawai-network/veridium';
...
export const PLUGINS_INDEX_URL = 'https://plugins.getkawai.com';
...
export const AGENTS_INDEX_GITHUB = 'https://github.com/kawai-network/kawai-agents';
...
export const BASE_PROVIDER_DOC_URL = urlJoin(OFFICIAL_SITE, 'docs/usage/providers');
