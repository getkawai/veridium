...
import { TOOGLE_PANEL_BUTTON_ID } from './TogglePanelButton';
...
const SessionPanel = memo<PropsWithChildren>(({ children }) => {
  ...
  const updatePreference = useCallback((params: any) => {
  ...
  // This effect is not needed with mock data and was causing re-renders
  // In the real implementation, this would sync the panel state with the store
  // useEffect(() => {
