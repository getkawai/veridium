...
const mockAgentStore = {
  removePlugin: (id: string) => {
    console.log('Mock removePlugin called with:', id);
  }
};
...
const mockToolStore = {
  getManifestLoadingStatus: (id: string) => (state: any) => 'success',
  isCustomPlugin: (id: string) => (state: any) => false,
  reinstallCustomPlugin: (id: string) => {
    console.log('Mock reinstallCustomPlugin called with:', id);
  },
  getManifestById: (id: string) => (state: any) => ({
    name: 'Sample Plugin',
    version: '1.0.0',
...
const toolSelectors = {
  getManifestLoadingStatus: (id: string) => (state: any) => state.getManifestLoadingStatus(id)(state),
  getManifestById: (id: string) => (state: any) => state.getManifestById(id)
};

const customPluginSelectors = {
  isCustomPlugin: (id: string) => (state: any) => state.isCustomPlugin(id)(state)
};
