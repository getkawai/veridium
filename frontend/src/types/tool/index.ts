// import { LobeChatPluginManifest, LobePluginType } from '@/chat-plugin-sdk';
...
export interface LobeTool {
  ...
  identifier: string;
  manifest?: any; // LobeChatPluginManifest | null;
  /**
   * use for runtime
   */
...
export type LobeToolRenderType = string | 'builtin'; // LobePluginType | 'builtin';
