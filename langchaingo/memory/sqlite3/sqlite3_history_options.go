...
// NOTE: This is legacy langchaingo code. In the main app, tables are created
// by database migrations (001_core_tables.sql). This schema serves as a fallback
// for standalone usage of langchaingo library. Safe due to CREATE TABLE IF NOT EXISTS.
