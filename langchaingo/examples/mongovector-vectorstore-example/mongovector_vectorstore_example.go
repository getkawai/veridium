...
func main() {
	...
	tempDir := filepath.Join(os.TempDir(), "chromem-mongo-example")
	...
	docs, err = store.SimilaritySearch(ctx, "South American cities", 4,
	...
	docs, err = store.SimilaritySearch(ctx, "South American cities", 2,
