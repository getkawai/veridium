...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/kawai-network/veridium/langchaingo.git
   ```
...
- Open a [GitHub Discussion](https://github.com/kawai-network/veridium/langchaingo/discussions)
