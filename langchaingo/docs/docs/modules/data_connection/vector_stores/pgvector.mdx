...
Here is the entire program (from [pgvector-vectorstore-example](https://github.com/kawai-network/veridium/langchaingo/blob/main/examples/pgvector-vectorstore-example/pgvector_vectorstore_example.go)):
