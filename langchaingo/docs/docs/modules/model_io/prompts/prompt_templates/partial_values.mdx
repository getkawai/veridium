...
For more examples, see the [comprehensive prompt templates example](https://github.com/kawai-network/veridium/langchaingo/tree/main/examples/prompt-templates-example).
