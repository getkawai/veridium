...
```bash
go get github.com/kawai-network/veridium/langchaingo
```
...
You can find the complete working example with all steps in the [tutorial-basic-chat-app](https://github.com/kawai-network/veridium/langchaingo/tree/main/examples/tutorial-basic-chat-app) directory.
