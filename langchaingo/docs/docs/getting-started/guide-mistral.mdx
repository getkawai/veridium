...
```shell
go run github.com/kawai-network/veridium/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-completion-example](https://github.com/kawai-network/veridium/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
