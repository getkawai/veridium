...
[![Go Reference](https://pkg.go.dev/badge/github.com/kawai-network/veridium/pkg/chromem.svg)](https://pkg.go.dev/github.com/kawai-network/veridium/pkg/chromem)
[![Build status](https://github.com/kawai-network/veridium/pkg/chromem/actions/workflows/go.yml/badge.svg)](https://github.com/kawai-network/veridium/pkg/chromem/actions/workflows/go.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/kawai-network/veridium/pkg/chromem)](https://goreportcard.com/report/github.com/kawai-network/veridium/pkg/chromem)
[![GitHub Releases](https://img.shields.io/github/release/kawai-network/veridium/pkg/chromem.svg)](https://github.com/kawai-network/veridium/pkg/chromem/releases)
...
import "github.com/kawai-network/veridium/pkg/chromem"
...
For the full interface see the Godoc: <https://pkg.go.dev/github.com/kawai-network/veridium/pkg/chromem>
...
- Embedding creators:
  ...
  - Bring your own (implement [`chromem.EmbeddingFunc`](https://pkg.go.dev/github.com/kawai-network/veridium/pkg/chromem#EmbeddingFunc))
...
- Performance:
  - Use SIMD for dot product calculation on supported CPUs (draft PR: [#48](https://github.com/kawai-network/veridium/pkg/chromem/pull/48))
...
`go get github.com/kawai-network/veridium/pkg/chromem@latest`

## Usage

See the Godoc for a reference: <https://pkg.go.dev/github.com/kawai-network/veridium/pkg/chromem>
...
PASS
ok   github.com/kawai-network/veridium/pkg/chromem 28.402s
```
