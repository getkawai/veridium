...
import (
	...
	"github.com/kawai-network/veridium/pkg/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/kawai-network/veridium/pkg/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/kawai-network/veridium/pkg/gooxml
